package com.example.demo.repository.prd;
...
@Repository
public interface TrafficVolumePrdRepository extends JpaRepository<TrafficVolumePrdResponse, Long> {

    @Query(value="SELECT"
    		+ " new TrafficVolumePrdResponse("
...
//    		+ " MAX(lr.class8) as maxTuktuk,"
    		...
    		+ " GROUP BY packetTs")
    List<TrafficVolumePrdResponse> findTrafficVolumeSumMaxUtcPlusQuery(long sensorId, Date startDate, Date endDate, String dateOption, String format, int interval, String utcLag);
...
//    		+ " AVG(lr.class8) as maxTuktuk,"
    		...
    		+ " WHERE s.id = ?1 AND lr.packetTs BETWEEN to_timestamp(?2, 'YYYY-MM-DD hh24:MI') - cast(CONCAT(?7,':00:00') as time) - cast(CONCAT(?6,':00:00') as time) AND to_timestamp(?3, 'YYYY-MM-DD hh24:MI') - cast(CONCAT(?7,':00:00') as time) - cast(CONCAT(?6,':00:00') as time)"
    		+ " GROUP BY packetTs")
    List<TrafficVolumePrdResponse> findTrafficVolumeSumAvgUtcPlusQuery(long sensorId, Date startDate, Date endDate, String dateOption, String format, int interval, String utcLag);
...
//    		+ " MAX(lr.class8) as maxTuktuk,"
    ...
    List<TrafficVolumePrdResponse> findTrafficVolumeSumLatestUtcPlusQuery(long sensorId, Date startDate, String dateOption, int interval);
...
//    		+ " MAX(lr.class8) as maxTuktuk,"
    		...
    		+ " GROUP BY packetTs")
    List<TrafficVolumePrdResponse> findTrafficVolumeSumMaxUtcPlusQueryByDay(long sensorId, Date startDate, Date endDate, String dateOption, int interval, String utcLag);
...
//    		+ " MAX(lr.class8) as maxTuktuk,"
    		...
    		+ " WHERE s.id = ?1 AND lr.packetTs BETWEEN to_timestamp(?2, 'YYYY-MM-DD hh24:MI') - cast(CONCAT(?6,':00:00') as time) - cast(CONCAT(?5,':00:00') as time) AND to_timestamp(?3, 'YYYY-MM-DD hh24:MI') - cast(CONCAT(?6,':00:00') as time) - cast(CONCAT(?5,':00:00') as time)"
    		+ " GROUP BY packetTs")
    List<TrafficVolumePrdResponse> findTrafficVolumeSumMaxUtcPlusQueryBy24Hours(long sensorId, Date startDate, Date endDate, String dateOption, int interval, String utcLag);
...
//    		+ " AVG(lr.class8) as averageTuktuk,"
    		...
    		+ " GROUP BY packetTs")
    List<TrafficVolumePrdResponse> findCorrelationTrafficUtcPlusQuery(long sensorId, Date startDate, Date endDate, String dateOption, int interval, int minutes, String utcLag);
...
//    		+ " MAX(lr.class8) as maxTuktuk,"
    		...
    		+ " WHERE s.id = ?1 AND lr.packetTs BETWEEN to_timestamp(?2, 'YYYY-MM-DD hh24:MI') - cast(CONCAT(?7,':00:00') as time) + cast(CONCAT(?6,':00:00') as time) AND to_timestamp(?3, 'YYYY-MM-DD hh24:MI') - cast(CONCAT(?7,':00:00') as time) + cast(CONCAT(?6,':00:00') as time)"
    		+ " GROUP BY packetTs")
    List<TrafficVolumePrdResponse> findTrafficVolumeSumMaxUtcMinusQuery(long sensorId, Date startDate, Date endDate, String dateOption, String format, int interval, String utcLag);
...
//    		+ " AVG(lr.class8) as maxTuktuk,"
    		...
    		+ " WHERE s.id = ?1 AND lr.packetTs BETWEEN to_timestamp(?2, 'YYYY-MM-DD hh24:MI') - cast(CONCAT(?7,':00:00') as time) + cast(CONCAT(?6,':00:00') as time) AND to_timestamp(?3, 'YYYY-MM-DD hh24:MI') - cast(CONCAT(?7,':00:00') as time) + cast(CONCAT(?6,':00:00') as time)"
    		+ " GROUP BY packetTs")
    List<TrafficVolumePrdResponse> findTrafficVolumeSumAvgUtcMinusQuery(long sensorId, Date startDate, Date endDate, String dateOption, String format, int interval, String utcLag);
...
//    		+ " MAX(lr.class8) as maxTuktuk,"
    		...
    		+ " GROUP BY packetTs"
    		+ " ORDER BY packetTs ASC")
    List<TrafficVolumePrdResponse> findTrafficVolumeSumLatestUtcMinusQuery(long sensorId, Date startDate, String dateOption, int interval);
...
//    		+ " MAX(lr.class8) as maxTuktuk,"
    		...
    		+ " WHERE s.id = ?1 AND lr.packetTs BETWEEN to_timestamp(?2, 'YYYY-MM-DD hh24:MI') - cast(CONCAT(?6,':00:00') as time) + cast(CONCAT(?5,':00:00') as time) AND to_timestamp(?3, 'YYYY-MM-DD hh24:MI') - cast(CONCAT(?6,':00:00') as time) + cast(CONCAT(?5,':00:00') as time)"
    		+ " GROUP BY packetTs")
    List<TrafficVolumePrdResponse> findTrafficVolumeSumMaxUtcMinusQueryByDay(long sensorId, Date startDate, Date endDate, String dateOption, int interval, String utcLag);
...
//    		+ " MAX(lr.class8) as maxTuktuk,"
    		...
    		+ " WHERE s.id = ?1 AND lr.packetTs BETWEEN to_timestamp(?2, 'YYYY-MM-DD hh24:MI') - cast(CONCAT(?6,':00:00') as time) + cast(CONCAT(?5,':00:00') as time) AND to_timestamp(?3, 'YYYY-MM-DD hh24:MI') - cast(CONCAT(?6,':00:00') as time) + cast(CONCAT(?5,':00:00') as time)"
    		+ " GROUP BY packetTs")
    List<TrafficVolumePrdResponse> findTrafficVolumeSumMaxUtcMinusQueryBy24Hours(long sensorId, Date startDate, Date endDate, String dateOption, int interval, String utcLag);
...
//    		+ " AVG(lr.class8) as averageTuktuk,"
    		...
    		+ " WHERE s.id = ?1 AND lr.packetTs BETWEEN to_timestamp(?2, 'YYYY-MM-DD hh24:MI') - cast(CONCAT(?7,':00:00') as time) + cast(CONCAT(?5,':00:00') as time) AND to_timestamp(?3, 'YYYY-MM-DD hh24:MI') - cast(CONCAT(?7,':00:00') as time) + cast(CONCAT(?5,':00:00') as time)"
    		+ " GROUP BY packetTs")
    List<TrafficVolumePrdResponse> findCorrelationTrafficUtcMinusQuery(long sensorId, Date startDate, Date endDate, String dateOption, int interval, int minutes, String utcLag);
